...
import 'package:template/core_dentist/errors/failures.dart';
import 'package:template/core_dentist/global_interceptor.dart';
...
class ApiService {
  ...
  Future<ApiResponse<T>> put<T>(
    ...
    if (hasFile) {
      ...
      return request<T>(path, method: 'PUT', data: formData);
    } else {
      FormData formData = FormData();
  ...
  Future<ApiResponse<T>> putListFiles<T>(
    String path, {
    Map<String, dynamic>? data,
    List<File>? files,
    String? fileKey,
