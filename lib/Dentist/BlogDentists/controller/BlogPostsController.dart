...
class MyBlogDoctorPostsController extends GetxController {
  final PostDoctorRepository repository;
  ...
  Future<void> openEditPost(
    ...
    if (updatedPost is BlogPostModel) {
    ...
    Get.snackbar(
      'تم التعديل',
      message.isNotEmpty ? message : 'تم تعديل المنشور بنجاح وإعادته للمراجعة.',
      snackPosition: SnackPosition.BOTTOM,
    );
  }
}
