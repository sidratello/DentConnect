...
import 'package:template/Dentist/BlogDentists/view/creat_post_wedjet/blog_images_picker.dart.dart';
import 'package:template/Dentist/BlogDentists/view/creat_post_wedjet/create_blog_header.dart';
...
class CreatedoctorBlogBody extends StatelessWidget {
  const CreatedoctorBlogBody({
    super.key,
  });
          ...
          Padding(
            ...
            child: Column(
              children: [
                Obx(
                  () {
                    if (controller.isEditMode) {
                      final post = controller.editingPost.value;

                      return AppNoteCard(
                        icon: Icons.edit_note_rounded,
                        color: const Color(0xFFE9A700),
                        backgroundColor: const Color(0xFFFFF7E1),
                        borderColor: const Color(0xFFFFD97D),
                        textColor: const Color(0xFF9D7000),
                        messages: [
                          post?.reviewMessage.trim().isNotEmpty == true
                              ? post!.reviewMessage.trim()
                ...
                AuthInputField(
                  title: 'عنوان المنشور *',
                  hintText: 'اكتب عنواناً واضحاً وجذاباً للمنشور',
                  controller: controller.titleController,
                  keyboardType: TextInputType.text,
                  validator: AppValidators.validateTitle,
                  fillColor: AppColors.white,
                  borderColor: AppColors.littleBlue.withOpacity(.9),
                ...
                AuthInputField(
                  title: 'محتوى المنشور *',
                  hintText: 'اكتب محتوى المنشور بالتفصيل...',
                  controller: controller.contentController,
                  keyboardType: TextInputType.multiline,
                  maxLines: 7,
                  validator: AppValidators.validateContent,
                  fillColor: AppColors.white,
                  borderColor: AppColors.littleBlue.withOpacity(.9),
                  focusedBorderColor: AppColors.primaryBlue,
